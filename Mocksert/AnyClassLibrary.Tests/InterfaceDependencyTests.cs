...
{
    public class InterfaceDependencyTests
    {
        ...
        private readonly AnyClassUnderTestWithInterfaceMembers _testObject;

        public InterfaceDependencyTests()
        {
            ...
            _anyInterfaceDependency1 = Mock.Create<IAnyInterfaceDependency>();
            _anyInterfaceDependency2 = Mock.Create<IAnyInterfaceDependency>();
            _anyInterfaceDependency3 = Mock.Create<IAnyInterfaceDependency>();

            _testObject = new AnyClassUnderTestWithInterfaceMembers(_anyInterfaceDependency1,
                                                                    _anyInterfaceDependency2,
                                                                    _anyInterfaceDependency3);
        }
        ...
        public void Passes_When_AnyGetSetProperty_Was_Arranged()
        {
            ...
            _anyInterfaceDependency1.Arrange(x => x.AnyGetSetProperty).Return(expected);
        ...
        {
            _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithSingleGenericType<bool>());
        ...
        public void Passes_When_AnyMethodWithReturnValue_Was_Arranged()
        {
            ...
            _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithReturnValue()).Return(expected);
        ...
        public void Passes_When_AnyMethodWithReturnValueAndParams_Was_Arranged()
        {
            ...
            _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithReturnValueAndParams(anyArgument1, anyArgument2, anyArgument3)).Return(expected);
        ...
        public void Passes_When_AnyMethodVoidWithParams_Was_Arranged()
        {
            ...
            _anyInterfaceDependency1.Arrange(x => x.AnyMethodVoidWithParams(anyArgument1, anyArgument2, anyArgument3));
        ...
        public void Does_Not_Throw_Exception_When_Any_Arranged_Null_Argument_Was_Provided()
        {
            ...
            _anyInterfaceDependency1.Arrange(x => x.AnyMethodVoidWithParams(anyArgument1, null, anyArgument3));
        ...
        public void Fails_When_Return_Extension_Method_Was_Not_Used()
        {
            Assert.Throws<MockException>(() =>
            {
                _anyInterfaceDependency1.Arrange(x => x.AnyGetOnlyProperty);
        ...
        public void Fails_When_The_Wrong_Argument_Was_Provided()
        {
            Assert.Throws<MockException>(() =>
            {
                ...
                _anyInterfaceDependency1.Arrange(x => x.AnyMethodVoidWithParams(anyArgument3, anyArgument2, anyArgument1));
        ...
        public void Fails_When_The_Wrong_Generic_Type_Argument_Was_Provided()
        {
            Assert.Throws<MockException>(() =>
            {
                _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithSingleGenericType<char>());
        ...
        public void GetGenericTypeArgumentFailureMessage_Returns_Correct_Mock_Failure_Message_With_Single_Namespace_Reduced_Generic_Type_Argument()
        {
            ...
            var mockException = Assert.Throws<MockException>(() =>
            {
                _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithSingleGenericType<IDictionary<int, IDictionary<IDictionary<IDictionary<IDictionary<bool, char>, string>, char>, int>>>());
        ...
        public void GetGenericTypeArgumentFailureMessage_Returns_Correct_Mock_Failure_Message_With_Multiple_Generic_Type_Arguments()
        {
            ...
            var mockException = Assert.Throws<MockException>(() =>
            {
                _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithMultipleGenericTypes<int, bool>());
        ...
        public void Fails_With_Multiple_Dependency_Arrangements_When_One_Or_Arrangements_Are_Provided_Invalid_Arguments()
        {
            ...
            var mockException = Assert.Throws<MockException>(() =>
            {
                ...
                _anyInterfaceDependency1.Arrange(x => x.AnyMethodWithReturnValueAndParams(_value01, _value04, _value07)).Return(_value10);
                _anyInterfaceDependency2.Arrange(x => x.AnyMethodWithReturnValueAndParams(_value02, _value13, _value08)).Return(_value11);
                _anyInterfaceDependency3.Arrange(x => x.AnyMethodWithReturnValueAndParams(_value03, _value06, _value09)).Return(_value12);
